# Autogenerated wrapper script for SoftPosit_jll for x86_64-apple-darwin14
export softposit
...
const softposit_splitpath = ["lib", "softposit.dylib"]
...
const softposit = "@rpath/softposit.dylib"
