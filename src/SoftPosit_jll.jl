...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import SoftPosit_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("f9aa12f2-fb2a-5e38-99be-91dba0a1f972"))
platforms = [Pkg.Artifacts.unpack_platform(e, "SoftPosit", artifacts_toml) for e in artifacts["SoftPosit"]]
...
if best_platform === nothing
    @debug("Unable to load SoftPosit; unsupported platform $(triplet(platform_key_abi()))")
else
